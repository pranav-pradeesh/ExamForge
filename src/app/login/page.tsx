      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="card animate-in" style={{ borderColor: '#1e1e24' }}>
          ...
          <div className="mt-6 pt-6 border-t text-center text-sm" style={{ borderColor: '#1e1e24', color: 'rgba(244,249,253,0.5)' }}>
            ...
            <Link href="/signup" className="transition-colors" style={{ color: '#2baffc' }}
              onMouseEnter={e => (e.currentTarget.style.color = '#55c360')}
              onMouseLeave={e => (e.currentTarget.style.color = '#2baffc')}>
              Sign up free
            </Link>
          </div>
        </div>
